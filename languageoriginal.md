...
1) Обработка информации - функциональная часть мозга без ощущений/квалиа/феноменального сознания, включает память
...
Согласно специальной теории относительности (СТО), событие в одной точке не может вызвать моментальный результат в другой точке, а "сейчас" происходит только в локальной точке отсчёта.
