...
Т.к. феноменальное сознание связано с коллапсом, это может помочь в определении причины, почему среда вызывает декогеренцию, 
выставление скорости течения времени также указывает на это.
