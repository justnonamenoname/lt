...
Эксперимент по созданию боли на расстоянии и изучение генератора квалиа и того, как задаются координаты квалиа,
может помочь разобраться с вопросом и лимитом расстояния.
