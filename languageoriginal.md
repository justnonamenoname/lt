...
В этом случае свойство квалиа преобразует квантовое состояние в квалиа и вызывает коллапс за счёт теоремы о запрете клонирования.
Это может снижать требования ко времени когерентности волновой функции квалиа, если других частиц со свойством квалиа рядом нет, 
...
и чтобы вызвать кадр сознания, частицу, которую необходимо держать отдельно, нужно запутывать с волновой функцией квалиа, только когда она готова.
