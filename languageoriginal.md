...
Lifeticle - частица, являющаяся субъектом, т.н. (так называемым) наблюдателем в мозге, с функцией:
...
Лайфтикл можно описать как частицу, способную к квалиа - это её свойство, и это и является жизнью - частица жизни (life+particle - lifeticle, lt).
...
2) Квантово запутанные частицы содержат информацию о квалиа, лайфтикл запутан с ними и ощущает их квантовое состояние.
...
5) Лайфтикл необходимо было бы держать под углом к феноменальному пространству для соответствия координат квалиа
...
Поэтому на вопрос: видит ли один человек синий - синим, а красный - красным, как другой человек - ответ: т.к. лайфтикл не занимается декодировкой, то нет причин считать цвет разным.
...
Удержание угла лайфтикла требует отдельного функционала, что также указывает на то, что координата квалиа, выставляется параметром, а не координатой.
...
Это в пользу лайфтикла как отдельного типа частицы, т.к. без существования уникальности - это возврат к проблеме небытия и невозможности ответить на вопрос выбора мозга.
...
Изображение может исчезать, значит, оно не является частью лайфтикла, а является внешним функционалом свойства квалиа с запутанностью.
...
А вариант, при котором лайфтикл одновременно находится в двух или нескольких параллельных мирах - бессмысленен и противоречив.
