...
**Необходимое для завершения теории**

Для завершения теории необходимо определить:
1) Расположение генератора квалиа
2) Как задаётся расположение квалиа
3) Как кодируются типы и параметры квалиа и точные формулы
4) Как именно работает обратное влияние при коллапсе и проявляется ли в других случайных квантовых процессах
5) Каким типом частицы является лайфтикл (элементарной частицей или другой) и точных свойств частицы
